...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([22, 1, 46, 11, 10, 14])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 63
    actual = sum_first_n([6, 16, 41, 11, 21], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 1
    actual = sum_first_n([0, -1, 1, 1, 21], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
