...
#   run_test_print_items_at_odd_indices(sequence1, sequence2, sequence3,
    # sequence4)
    # ## threw an error if uncommented while
    # run_test_print_items_in second_half ran, but not while second half was
    #  commented
...
def print_items_at_odd_indices(sequence):
    ...
    for i in range(1,len(sequence)+1,2):
        print(sequence[i],"is at index ",i)
